...
- ❌ GmSSL master 互操作记录层：`interop/AUDIT-2026-09-06-v2.md` v2-rev11 新增 Critical finding F4：gm-tlcp ↔ gmssl-master 3.3.0-dev.1183 的握手 **能够**成功（首次正证据，R-8），但记录层 app-data 交换在成功后挂起。gmssl 进程 95% CPU 忙等 `do_send_select -> tls_send` 重试循环。scope = R-9。
