...
/// SM2 signature algorithm OID: 1.2.156.10197.1.501 (sm3WithSM2).
/// DER base-128: 1.2 = 0x2A, 156 = 0x81 0x1C, 10197 = 0xCF 0x55,
/// 1 = 0x01, 501 = 0x83 0x75.
pub const SM2_SIG_OID: &[u8] = &[0x2A, 0x81, 0x1C, 0xCF, 0x55, 0x01, 0x83, 0x75];
/// SM2 public key OID: 1.2.156.10197.1.301.
/// DER base-128: ... 301 = 0x82 0x2D.
pub const SM2_PK_OID: &[u8] = &[0x2A, 0x81, 0x1C, 0xCF, 0x55, 0x01, 0x82, 0x2D];
